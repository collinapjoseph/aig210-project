...
CLASSIFIER_SAVE_PATH = MODEL_DIR / "gesture_classifier.joblib"
SCALER_SAVE_PATH = MODEL_DIR / "gc_scaler.joblib"
...
def main():
    ...
    # save scaler and best classifier
    joblib.dump(scaler, SCALER_SAVE_PATH)
    joblib.dump(best_model, CLASSIFIER_SAVE_PATH)
    print("Saved scaler and best model.")
